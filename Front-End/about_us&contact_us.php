...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/about_us&contact_us.css" />
          ...
          <div class="row pt-5 mt-3">
              <div class="col-md-12 mb-3">
                  <div class="intro-info-content text-center">
                      <h1 class="display-2 white-text mb-5 wow fadeInDown font-weight-bold" data-wow-delay="0.3s">ABOUT <a class="white-text font-weight-bold">US</a></h1>
                      <h1 class="text-light bg-dark white-text mb-5 mt-5 font-weight-bold" data-wow-delay="0.3s">We're MasterTech Computer Accessories</h1>
  ...
  <main>
    ...
    <div class="container">
            ...
            <div class="row mb-lg-4 text-center text-md-left">
                ...
                <div class="col-lg-6 col-md-12 mb-4">
                    ...
                    <div class="col-md-12 float-right ">
                        ...
                        <h6 class="font-weight-bold grey-text mb-4">CEO-Full Stack Developer</h6>
                        <!-- LinkedIn -->
                ...
                <div class="col-lg-6 col-md-12 mb-4">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="avatar mx-auto mb-md-0 mb-3">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(28).jpg" class="z-depth-1" alt="Second sample avatar image">
                        </div>
                    </div>

                    <div class="col-md-12 float-right">
                        <h4><strong>Jane de Mel</strong></h4>
        ...
        <section id="products" class="text-center wow fadeIn" data-wow-delay="0.3s">
            ...
            <!-- Section heading -->
            <h1 class="font-weight-bold text-center h1 my-5">We provide awesome services</h1>
            <!-- Section description -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p class="grey-text">You can compare the prices and create your wishlists.</p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <h4 class="font-weight-bold my-4">Quotations</h4>
                    <p class="grey-text">You can request for official quotations from us.</p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <h4 class="font-weight-bold my-4">Buy on click</h4>
                    <p class="grey-text">We facilitate you to buy world range products.</p>
                </div>
                <!-- Grid column -->
        ...
        <section id="gallery" class="section wow fadeIn" data-wow-delay="0.3s">
            ...
            <!-- Section heading -->
            <h1 class="font-weight-bold text-center h1 my-5">Our Products</h1>
            <!-- Section description -->
            <p class="text-center grey-text mb-5 mx-auto w-responsive">We always try to give you the premium feel of shopping</p>
             ...
             <div class="row mb-lg-4 text-center text-md-left">
                ...
                <!-- Grid column01 -->
                <div class="col-md-6 float-left">
                            <img src="./uploads/Screenshot 2021-09-25 at 16-51-41 https www daraz lk.png" class="img-fluid z-depth-1" style="height:400px" />
                            <br><br>               
                 </div>
                <!-- Grid column01 -->
                ...
                <!-- Grid column02 -->
                <div class="col-md-6 float-left">
                        <img src="./Index/images/monitor.jpg" class="img-fluid z-depth-1" style="height:400px" />
                        <br><br>             
                </div>
                <!-- Grid column02 -->
                ...
                <!-- Grid column03 -->
                <div class="col-md-6 float-left">
                        <img src="./Index/images/tharnos.jpg" class="img-fluid z-depth-1" style="height:400px" />
                        <br><br>                
                </div>
                <!-- Grid column03 -->
                 ...
                 <!-- Grid column04-->
                 <div class="col-md-6 float-left">
                        <img src="./Index/images/gaming-desktop.jpg" class="img-fluid z-depth-1" style="height:400px" />
                        <br><br>             
                </div>
                <!-- Grid column04-->
        ...
        <section id="contact" class="section pb-5 wow fadeIn" data-wow-delay="0.3s">
            ...
            <!-- Section description -->
            <p class="text-center grey-text mb-5 mx-auto w-responsive">You can contact our Customer Service for all questions and queries on any of the following channels during office hours</p>
                ...
                <div class="col-md-4 col-xl-3">
                    <ul class="contact-icons text-center list-unstyled">
                        <li><i class="fas fa-map-marker fa-2x"></i>
                            <p>No 101,Galle Road, Colombo, SL</p>
                        </li>
