<?php
    ...
    $stmt = $link->prepare('SELECT * FROM product WHERE  = ?');
    ...
    // Prevent form resubmission...
	//include cart page as header link  header('location: index.php?page=cart');
    exit;
}

// Send the user to the place order page if they click the Place Order button, also the cart should not be empty
if (isset($_POST['placeorder']) && isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
	 //include placeorder page as header
    exit;
}
...
if ($products_in_cart) {
    ...
    $stmt = $link->prepare('SELECT * FROM products WHERE id IN (' . $array_to_question_marks . ')');
